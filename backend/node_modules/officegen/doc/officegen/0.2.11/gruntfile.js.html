...
<head>
    <meta charset="utf-8">
    <title>Source: gruntfile.js</title>
...
<div class="navigation">
    ...
    <ul class="list">
        ...
        <li class="item" data-name="makePptx">
            ...
            <span class="subtitle">Members</span>
                ...
                <li data-name="makePptx~pptWidth"><a href="makePptx.html#~pptWidth">pptWidth</a></li>
    ...
    <div class="main">
        <h1 class="page-title" data-filename="gruntfile.js.html">Source: gruntfile.js</h1>
    ...
    <section>
        <article>
            <pre id="source-code" class="prettyprint source "><code>var path = require ( 'path' );
...
module.exports = function ( grunt ) {
	...
	grunt.loadNpmTasks ( 'grunt-jsdoc' );
        ...
        <footer>
            Documentation generated by <a href="https://github.com/jsdoc3/jsdoc">JSDoc 3.4.0</a> on Thu Sep 15 2016 16:30:26 GMT+0200 (W. Europe Daylight Time)
        </footer>
    </div>
</div>
